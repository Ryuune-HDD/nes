...
void Mapper001_Write(uint8_t byData, uint16_t wAddr) //VROM_1K_SIZE
{
    uint32_t dwRegNum;
    ...
    case 1:
        {
            uint8_t byBankNum = MAP1->Map1_Regs[1];
    ...
    case 2:
        {
            uint8_t byBankNum = MAP1->Map1_Regs[2];
    ...
    case 3:
        {
            uint8_t byBankNum = MAP1->Map1_Regs[3];
