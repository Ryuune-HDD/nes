...
void NES_mapper49::MemoryWriteSaveRAM(uint32_t addr, uint8_t data)
{
    if (regs[2] & 0x80)
    {
        regs[1] = data;
...
void NES_mapper49::MemoryWrite(uint32_t addr, uint8_t data)
{
    switch (addr & 0xE001)
    {
    case 0x8000:
...
void NES_mapper49::HSync(uint32_t scanline)
{
    if (irq_enabled)
    {
