...
void NES_mapper235::MemoryWrite(uint32_t addr, uint8_t data)
{
    uint8_t prg_bank = ((addr & 0x0300) >> 3) | (addr & 0x001F);
    uint8_t open_bus = 0;
    ...
    if (num_8k_ROM_banks == 64 * 2)
    {
        ...
        {
        case 0x0000: break;
        case 0x0100: open_bus = 1;
            break;
        case 0x0200: open_bus = 1;
            break;
        case 0x0300: open_bus = 1;
            break;
        }
    }
    else if (num_8k_ROM_banks == 128 * 2)
    {
        ...
        case 0x0100: open_bus = 1;
            break;
        case 0x0200: prg_bank = (prg_bank & 0x1F) | 0x20;
            break;
        case 0x0300: open_bus = 1;
            break;
        }
    ...
    else if (num_8k_ROM_banks == 192 * 2)
    {
        ...
        case 0x0200: prg_bank = (prg_bank & 0x1F) | 0x20;
            break;
        case 0x0300: prg_bank = (prg_bank & 0x1F) | 0x40;
            break;
        }
    }
