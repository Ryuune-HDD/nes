...
void NES_mapper187::MemoryWriteLow(uint32_t addr, uint8_t data)
{
    if (addr == 0x5000)
    {
        ex_bank_mode = data;
...
void NES_mapper187::MemoryWrite(uint32_t addr, uint8_t data)
{
    switch (addr)
    {
    case 0x8000:
...
void NES_mapper187::HSync(uint32_t scanline)
{
    if (irq_enabled)
    {
