...
void NES_mapper189::MemoryWriteLow(uint32_t addr, uint8_t data)
{
...
void NES_mapper189::MemoryWrite(uint32_t addr, uint8_t data)
{
    switch (addr)
    {
    case 0x8000:
...
void NES_mapper189::HSync(uint32_t scanline)
{
    if (irq_enabled)
    {
