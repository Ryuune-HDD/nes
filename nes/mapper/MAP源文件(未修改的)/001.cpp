...
void NES_mapper1::MemoryWriteSaveRAM(uint32_t addr, uint8_t data)
{
...
void NES_mapper1::MemoryWrite(uint32_t addr, uint8_t data)
{
    if (patch&& addr
    ==
    0xBFFF
