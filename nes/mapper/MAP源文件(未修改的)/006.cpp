...
void NES_mapper6::MemoryWriteLow(uint32_t addr, uint8_t data)
{
    switch (addr)
    {
    case 0x42FE:
...
void NES_mapper6::MemoryWrite(uint32_t addr, uint8_t data)
{
...
void NES_mapper6::HSync(uint32_t scanline)
{
    if (irq_enabled)
    {
        irq_counter += 133;
