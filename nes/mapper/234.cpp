...
void NES_mapper234::MemoryReadSaveRAM(uint32_t addr)
{
    NES_6502::Context context;
    parent_NES->cpu->GetContext(&context);
    uint8_t data = context.mem_page[addr >> 13][addr & 0x1fff];
...
void NES_mapper234::MemoryWrite(uint32_t addr, uint8_t data)
{
    switch (addr & 0xFFF8)
    {
    case 0xFF80:
