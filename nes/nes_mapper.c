...
void Mapper_Init(void)
{
    ...
    case 99: MAP99_Init();
        break;
    case 113: MAP113_Init();
        break;
    case 189: MAP189_Init();
        break;
    case 225: MAP225_Init();
        break;
    case 227: MAP227_Init();
        break;
    case 240: MAP240_Init();
        break;
    case 245: MAP245_Init();
        break;
    default: break;
    }
    NES_Mapper->Reset();
...
uint8_t asm_Mapper_ReadLow(uint16_t wAddr) //添加的
{
    return NES_Mapper->ReadLow(wAddr);
}
